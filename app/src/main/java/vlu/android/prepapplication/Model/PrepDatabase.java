    ...
    private static RoomDatabase.Callback sRoomDatabaseCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                StudentExamQuestionCrossRef stex = new StudentExamQuestionCrossRef(1,1,1);
                daostex.insert(stex);
                stex = new StudentExamQuestionCrossRef(2,1,1);
                daostex.insert(stex);
                stex = new StudentExamQuestionCrossRef(3,1,1);
                daostex.insert(stex);
            });
